...
Visit the [Community Fisheries Data Dashboard](https://barefootocean.shinyapps.io/fisheries_dashboard/) website. To get started, follow the steps below to use the community fisheries dashboard: 
