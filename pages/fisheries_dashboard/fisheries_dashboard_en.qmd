...
Visit the [Barefoot Ocean Community Fisheries Data Dashboard](http://barefootocean.shinyapps.io/fisheries_dashboard_demo/) website (<https://barefootocean.shinyapps.io/fisheries_dashboard_demo/>). To get started, follow the steps below to use the community fisheries dashboard: 
...
Additional data selections include habitat and date range. Available habitat types include: reef, pelagic-shallow, soft bottom-shallow, hard bottom-shallow, pelagic-deep, hard bottom-deep, soft bottom-deep, and mangrove. The selected date range types include past year, past six months, past month, and past week. The dashboard also has an option to show income in \$USD and show confidence intervals on the following time series plots.
