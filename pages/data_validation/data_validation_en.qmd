...
![](images/fig1.jpg){width="506"}

`r { i18n$t("caption2") }`

![](images/fig2.jpg){width="471"}
...
![](images/fig3.jpg){width="476"}

`r { i18n$t("caption4") }`

![](images/fig4.jpg){width="476"}
...
`r { i18n$t("faq") }` 1. `r { i18n$t("q1") }` - `r { i18n$t("a1") }`
...
![](images/qa_workflow.jpg){width="476"}
